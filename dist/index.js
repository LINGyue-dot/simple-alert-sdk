(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('util'), require('stream'), require('path'), require('http'), require('https'), require('url'), require('fs'), require('assert'), require('zlib'), require('events')) :
	typeof define === 'function' && define.amd ? define(['util', 'stream', 'path', 'http', 'https', 'url', 'fs', 'assert', 'zlib', 'events'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SimpleAlertSDK = factory(global.require$$1, global.stream, global.require$$1$1, global.require$$3, global.require$$4, global.require$$0$1, global.require$$6, global.require$$4$1, global.zlib, global.EventEmitter));
})(this, (function (require$$1, stream, require$$1$1, require$$3, require$$4, require$$0$1, require$$6, require$$4$1, zlib, EventEmitter) { 'use strict';
	...
	function send(errorData) {
	    ...
	    axios$1.request({
	        method: "post",
	        url: "".concat(AlertStore.options.baseUrl, "/report"),
	        data: {
	            alertData: {
